...
int main(){
  ...
  IContainer* container6 = new FragileContainer("_", "Cargo A", 7, 8, 1, 21.2, 2.1, 22.2);
  IContainer* container7 = new FragileContainer("_", "Cargo A", 7, 8, 3, 21.2, 2.1, 12.2);
  IContainer* container8 = new FragileContainer("_", "Cargoc", 8, 9, 4, 21.2, 3, 2.3);
  st->addContainer(container, 0, 0, 0);
  st->addContainer(container2, 0, 0, 3);
  st->addContainer(container3, 0, 0, 5);
  st->addContainer(container4, 0, 0, 7);
  st->addContainer(container5, 0, 0, 9);
