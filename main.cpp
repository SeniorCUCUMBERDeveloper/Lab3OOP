...
int main(){
  ...
  //  requestThread.join();
   ...
   IContainer* container = new FragileContainer("_", "Cargo A", 2, 4, 1, 21.2, 2.1, 300.0);
   IContainer* container2 = new Container("_", "Cargo A", 4, 10, 1, 21.2, 2.1);
   st->addContainer(container, 0, 0, 0);
  st->addContainer(container2, 16, 17, 0);
